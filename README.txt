<---------------- Kanban V2 application ----------------->


This is a manual for the users on how to use the Kanban V2 application.

Kanban aims to track your activities by the data that the user provides and it can be used to sincerely track deadlines of tasks.
...
7) In one of the two terminals, enter the command "python3 application.py" to start the flask API server
...
These are the general instructions on how to use the Kanban V2 application.
